 ...
 */
async function investigateDiscovery({ tick, cell, cellLabel, agent1Name, agent2Name, layer0Cell, layer2Cell, packName, dataKeywords, hypothesisKeywords, priorSummary, meetingPoint: meetingPointOverride, cubeMode, goldenCollision }) {
  ...
  if (isCube) {
    ...
    const goldenClause = (goldenCollision && goldenCollision.score > 0)
      ? `\n--- COLLISION SCORING ---
Method distance: ${goldenCollision.components.methodDistance} | Surprise product: ${goldenCollision.components.surpriseProduct} | Semantic distance: ${goldenCollision.components.semanticDistance}
...
CLUSTER A [cell ${layer0Cell.cell}] — Method: ${layer0Cell.methodLabel} | Surprise: ${layer0Cell.surpriseLabel} | Semantic: ${layer0Cell.clusterLabel} (${layer0Cell.paperCount} papers)
Representative papers:
${formatCellPapers(layer0Cell)}

CLUSTER B [cell ${layer2Cell.cell}] — Method: ${layer2Cell.methodLabel} | Surprise: ${layer2Cell.surpriseLabel} | Semantic: ${layer2Cell.clusterLabel} (${layer2Cell.paperCount} papers)
Representative papers:
${formatCellPapers(layer2Cell)}

Meeting point: ${meetingPoint}
${goldenClause}${dormantGapClause}${priorClause}
