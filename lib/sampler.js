...
const SOURCE_WEIGHTS = {
  openalex: 0.50,    // OpenAlex random diverse fields
  pubmed: 0.10,      // PubMed via Europe PMC (requires NCBI_API_KEY or uses Europe PMC)
  preprints: 0.15,   // bioRxiv/medRxiv/arXiv fresh preprints
  anomaly: 0.10,     // OpenAlex targeted anomaly sampling
  s2: 0.10,          // S2 keyword queries (legacy, method/surprise biased)
