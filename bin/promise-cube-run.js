...
import { runBelofteCube } from '../src/bieb/belofte-cube.js';
import { BeloofteLibrary } from '../src/bieb/belofte-library.js';
import { resolvePromiseLibraryLayout, DEFAULT_GAP_LIBRARY_PATH } from '../src/bieb/promise-paths.js';
...
async function main() {
  const cubeRun = await runBelofteCube({
